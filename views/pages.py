...
class SearchHandler(HtmlHandler):
    def get(self):
        ...
        self.HtmlResponse("page_search.html", {"mode": "index", "type": _type, "name": types[_type], "right": right, "left": left, "rightURL": rightURL, "leftURL": leftURL, "text": text , "className": className, "img": img })
